    ...
    <section className="py-12 border-y border-slate-100 dark:border-slate-800 bg-white dark:bg-slate-950">
      <div className="mx-auto w-full max-w-6xl px-5 sm:px-8 lg:px-10">
        ...
        <div className="mt-6 grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-6">
          {types.map((type) => (
            <div key={type.label} className="flex flex-col items-center gap-2 rounded-xl border border-slate-100 dark:border-slate-800 bg-slate-50/50 py-5 text-center transition-colors hover:bg-slate-100/60">
              <type.icon className="h-5 w-5 text-slate-500 dark:text-slate-400" />
