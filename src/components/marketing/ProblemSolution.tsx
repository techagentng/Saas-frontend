...
export function ProblemSolution() {
  return (
    <section id="problem" className="py-20 sm:py-24 lg:py-28 bg-slate-50/60">
      <div className="mx-auto w-full max-w-6xl px-5 sm:px-8 lg:px-10">
        <div className="max-w-2xl">
          ...
          <Reveal delay={60}><h2 className="mt-4 text-3xl font-bold tracking-tight text-slate-900 sm:text-4xl">Running on appointments shouldn&apos;t mean running in circles.</h2></Reveal>
        </div>
        ...
        <Reveal delay={200}>
          <div className="mt-12 rounded-2xl border border-brand-200/60 bg-brand-50/50 p-8 text-center sm:p-10">
            <h3 className="text-xl font-semibold text-slate-900 sm:text-2xl">One booking system. One dashboard. One simple customer experience.</h3>
            <p className="mx-auto mt-3 max-w-xl text-sm text-slate-600">Bring everything under one roof so you can focus on the work, not the admin.</p>
          </div>
        </Reveal>
      </div>
    </section>
