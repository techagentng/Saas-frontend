    ...
    <section id="features" className="py-20 sm:py-24 lg:py-28 bg-white">
      <div className="mx-auto w-full max-w-6xl px-5 sm:px-8 lg:px-10">
        <div className="max-w-2xl">
          ...
          <Reveal delay={60}><h2 className="mt-4 text-3xl font-bold tracking-tight text-slate-900 sm:text-4xl">Everything you need to run bookings, built in.</h2></Reveal>
        </div>
          ...
          {features.map((f, i) => (
            <Reveal key={f.title} delay={i * 80}>
              <article className="card card-hover h-full p-6">
                <div className="flex h-11 w-11 items-center justify-center rounded-xl bg-brand-50 text-brand-600 ring-1 ring-inset ring-brand-600/10">
