...
export function DashboardPreview() {
  return (
    <section id="product" className="py-20 sm:py-24 lg:py-28 bg-white border-t border-slate-100">
      <div className="mx-auto w-full max-w-6xl px-5 sm:px-8 lg:px-10">
        <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
          <div>
            ...
            <Reveal delay={60}><h2 className="mt-4 text-3xl font-bold tracking-tight text-slate-900 sm:text-4xl">Your entire business in one dashboard.</h2></Reveal>
            <Reveal delay={120}><p className="mt-4 text-base text-slate-600">Business owners and staff use a secure, tenant-aware dashboard to manage day-to-day operations. Give staff the access they need without exposing controls they shouldn&apos;t use.</p></Reveal>
            <Reveal delay={180}>
          ...
          <Reveal delay={120}>
            <div className="rounded-2xl border border-slate-200 bg-slate-50 p-2 shadow-card">
              <div className="rounded-xl bg-white p-4 shadow-sm">
                <div className="mb-4 flex gap-2 border-b border-slate-100 pb-3">
                  ...
                  <span className="rounded-md px-3 py-1 text-xs font-medium text-slate-500">Bookings</span>
                  <span className="rounded-md px-3 py-1 text-xs font-medium text-slate-500">Customers</span>
                </div>
                <div className="grid grid-cols-3 gap-2">
                  <div className="col-span-2 rounded-lg border border-slate-200 p-3">
                    <p className="text-[10px] text-slate-400">Revenue (May)</p>
                    <p className="mt-1 text-base font-semibold text-slate-900">$4,250</p>
                ...
                <div className="mt-2 rounded-lg border border-slate-200">
                  <div className="border-b border-slate-100 px-3 py-2 text-[10px] font-medium text-slate-700">Upcoming Appointments</div>
