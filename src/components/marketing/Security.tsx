    ...
    <section className="py-20 sm:py-24 lg:py-28 bg-white dark:bg-slate-950 border-t border-slate-100 dark:border-slate-800">
      <div className="mx-auto w-full max-w-6xl px-5 sm:px-8 lg:px-10">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <Reveal delay={60}><h2 className="mt-4 text-3xl font-bold tracking-tight text-slate-900 dark:text-white sm:text-4xl">Built with security in mind.</h2></Reveal>
          <Reveal delay={120}><p className="mt-4 text-base text-slate-600 dark:text-slate-400">Built with secure account access and business-level data separation at its core.</p></Reveal>
        </div>
